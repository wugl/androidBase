...
public class SelectAddressPopWindow extends PopupWindow implements View.OnClickListener {
    ...
    private String strProvince = "广西";
    private String strCity = "桂林";
    private String strArea = "七星区";
    private OnAddressCListener onAddressCListener;

    private int maxsize = 14;
    private int minsize = 12;

    public SelectAddressPopWindow(final Context context) {

        this(context, "", "", "");
    }

    public SelectAddressPopWindow(final Context context, String province, String city, String area) {
        super(context);
        ...
        if (area != null && !area.equals(""))
            this.strArea = area;
        View view = View.inflate(context, R.layout.select_address_pop_layout, null);
