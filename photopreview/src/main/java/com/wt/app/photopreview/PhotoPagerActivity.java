package com.wt.app.photopreview;
...
import com.wt.app.photopreview.fragment.ImagePagerFragment;

import java.util.List;

/**
 * Created by Samuel on 15/6/24.
 */
public class PhotoPagerActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        intent.putExtra(PhotoPreview.KEY_SELECTED_PHOTOS, pagerFragment.getPaths());
